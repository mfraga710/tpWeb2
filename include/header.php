...
<header>
    ...
    <nav class="navbar">
        <header class="nabvar-mobile">
            ...
            <a class="navbar-mobile-link has-text-white" href="index.php">Avenue Fashion</a>
        ...
        <nav class="nav-menu" id="mySidenav">
            ...
            <a class="is-hidden-mobile brand is-uppercase has-text-weight-bold has-text-dark" href="index.php">Avenue Fashion</a>
            <ul class="nav-menu-ul">
                ...
                <li class="nav-menu-item"><a href="lookbook.php" class="nav-menu-link">Look Book</a></li>
                <li class="nav-menu-item"><a href="login.php" class="nav-menu-link">Registro</a></li>
